...
import type { NewAccessoryInput } from 'src/types/accessories';
...
const emit = defineEmits<{
  ...
  (e: 'submit', value: NewAccessoryInput): void;
}>();

const isDragging = ref(false);
const fileInput = ref<HTMLInputElement | null>(null);
const previewUrl = ref<string>(getDefaultImage('accessory'));
...
function addNewAccessory() {
  try {
    ...
    // Emit the submit event with the new accessory data
    emit('submit', newAccessory.value);
    closeDialog();
  } catch (error) {
