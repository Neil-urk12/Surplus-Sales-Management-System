...
const props = defineProps({
    ...
    initialFilterCategory: { type: String as PropType<string | null>, default: null },
    initialFilterSupplier: { type: String as PropType<string | null>, default: null },
    initialFilterStatus: { type: String as PropType<MaterialStatus | null>, default: null },
});
    ...
    <q-dialog :model-value="modelValue" @update:model-value="closeDialog">
        <q-card style="min-width: 350px">
            ...
            <q-card-section class="q-pt-none">
                <q-select v-model="localFilterCategory" :options="categories" label="Category" clearable outlined dense
                    class="q-mb-md" />

                <q-select v-model="localFilterSupplier" :options="suppliers" label="Supplier" clearable outlined dense
                    class="q-mb-md" />
